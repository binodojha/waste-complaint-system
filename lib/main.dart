...
import 'package:swms/screens/admin/admin_user_manage_screen.dart';
      ...
      child: SafeArea(
        child: MaterialApp(
          ...
          routes: {
            ...
            CollectorProfileScreen.id: (context) => CollectorProfileScreen(),
            CollectorComplaintScreen.id: (context) =>
                CollectorComplaintScreen(),
          },
        ),
      ),
    );
